...
<div class="text-left text-base mb-8">
  〈부재시 픽션은 문 앞에 놔주세요〉의 키오스크를 보던 관객은 4장에서 물품 리스트를 확인한다. 이 리스트는 10월 30일 공연의 소품 후보들이다. 전시장에서 공연을 예매하는 관객은 공연에서 어떤 소품이 등장할지 선택할 수 있다. 선택된 물품은 곧바로 주문이 들어가고 전시장으로의 배송완료와 동시에 전시된다.
</div>
