        ...
        <div className="bg-[#2d2d2d] p-8 border border-[#404040]">
          <div className="overflow-x-auto">
            <table className="w-full">
              <tbody>
                <tr>
                  <td className="py-4 px-4 text-lg font-bold text-[#F8D1E7] w-1/4 align-top">반재하</td>
                  <td className="py-4 px-4 text-lg text-[#e5e5e5] leading-relaxed w-3/4">
                    30대 중반 여. 전시 《방금 전의 소문과 오래된 증거로부터》의 사전 리서치로 중국에 간 작가. 2018년 북한 프로파간다 이미지가 프린팅된 물품들을 수입한 것을 계기로 55일 간의 검열과정을 거친 후 분단에 관심을 가지며 작업을 이어가고 있다. 남들이 분단에 대해 관심갖지 않는 지점을 파헤치고 싶어한다.
                  </td>
                </tr>
                ...
                <tr>
                  <td className="py-4 px-4 text-lg font-bold text-[#F8D1E7] w-1/4 align-top">박연희</td>
                  <td className="py-4 px-4 text-lg text-[#e5e5e5] leading-relaxed w-3/4">
                    60대 중반 여. 남한에 정착한지 10년이 넘었으며 한국으로 귀화한 조선족. 중국에서 살던 시절 중국과 북한을 오가며 장사를 하기도 하고 북한을 다수 여행한 경험이 있다.
                  </td>
                </tr>
                ...
                <tr>
                  <td className="py-4 px-4 text-lg font-bold text-[#F8D1E7] w-1/4 align-top">세관</td>
                  <td className="py-4 px-4 text-lg text-[#e5e5e5] leading-relaxed w-3/4">
                    수출입 물품에 관세를 부과하고 징수하며, 밀수·밀무역을 단속하여 국내 산업과 사회 안전을 보호하는 임무를 수행한다. 전시장으로 들어오는 북한 물건을 감시할 수도, 안 할 수도 있다.
                  </td>
                </tr>
